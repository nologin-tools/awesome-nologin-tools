...
- **[Cubic Bezier](https://cubic-bezier.com)** ([Source](https://github.com/LeaVerou/cubic-bezier) ⭐182) — Visual CSS cubic-bezier timing function editor. Drag control points to create custom easing curves and compare with presets.
  > _No-login task: Edit CSS bezier easing curves_
- **[Diagrams.net](https://app.diagrams.net)** ([Source](https://github.com/jgraph/drawio) ⭐3789) — Create flowcharts, UML diagrams, network diagrams, and more. Formerly draw.io, the most powerful free online diagramming tool.
...
- **[Realtime Colors](https://realtimecolors.com)** ([Source](https://github.com/juxtopposed/realtimecolors) ⭐918) — Preview color palettes on a real page layout in real time. See exactly how your colors look on text, buttons, and backgrounds.
  > _No-login task: Preview color schemes on real layouts_
- **[SVG Edit](https://svgedit.netlify.app/editor/index.html)** ([Source](https://github.com/SVG-Edit/svgedit) ⭐7519) — Fast, web-based, JavaScript-driven SVG drawing editor. Create and edit SVG images directly in the browser with a familiar drawing application interface.
...
- **[tldraw](https://tldraw.com)** ([Source](https://github.com/tldraw/tldraw) ⭐45536) — A collaborative digital whiteboard with a clean, minimal interface. Draw freehand, add shapes, arrows, text, and sticky notes to create diagrams and visual notes.
...
- **[Rust Playground](https://play.rust-lang.org)** ([Source](https://github.com/rust-lang/rust-playground) ⭐1389) — Official Rust online compiler and execution environment. Write, compile, and run Rust code directly in the browser.
...
- **[next-tools](https://next-tools.dev)** ([Source](https://github.com/willjayyyy/next-tools) ⭐18) — This is a tool website forked from it-tools, containing 100+ tools.
...
- **[Excalideck](https://excalideck.com)** ([Source](https://github.com/excalideck/excalideck) ⭐194) — Create hand-drawn style presentation slides using the Excalidraw engine. Build unique, sketch-like slide decks.
...
- **[led.run ★](https://led.run)** ([Source](https://github.com/led-run/led.run) ⭐93) — A browser-based display toolkit that turns any screen into a LED sign, light effect, sound visualizer, clock, QR code, or camera filter. Supports dozens of themes and modes — no app, no account, just a URL.
...
- **[Yopass](https://yopass.se)** ([Source](https://github.com/jhaals/yopass) ⭐2595) — Share secrets securely with end-to-end encryption. Messages self-destruct after being read or after a set expiration time.
...
- **[Sort Visualizer](https://sortvisualizer.com)** ([Source](https://github.com/Myphz/sortvisualizer) ⭐149) — Watch sorting algorithms in action with animated bar charts. Compare bubble sort, quicksort, merge sort, and more side by side.
